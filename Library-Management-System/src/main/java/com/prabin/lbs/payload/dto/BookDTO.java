...
public class BookDTO {
	...
	@NotNull(message = "Gnere is mandatory")
	...
	@Size(max=20, message="Language must not exceed 20 charcters")
	...
	@Digits(integer = 8, fraction = 2, message = "Price must have at most 8 integer digits and 2 charcters")
	private BigDecimal price;
	
	@Size(max = 500, message = "Image URL must not exceed 500 characters")
	private String coverImageUrl;
	
	private Boolean alreadayHaveLoan;
